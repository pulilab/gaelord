...
from gaelord.conf import RECORDS_QUEUE_SIZE

_records_queue = deque()
def add(record):
    if len(_records_queue) == RECORDS_QUEUE_SIZE:
        _records_queue.popleft()
    
    _records_queue.append(record)
